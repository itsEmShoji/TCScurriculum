...
# TODO: the rows are named by letters
# TODO: the columns are named by numbers

# TODO: lets first create a set of all the squares
# format: ['1A', '1B', '1C', '1D', '1E', '1F', '1G', '1H', '1I', '2A'...]
...
# each square should belong to three units, its row, column, and block
...
def eliminate(solution, square, value):
    ...
    """
    # TODO: if the value we're eliminating is not in the square we're looking at, return

    # TODO: remove the value from the current square by replacing it with ''
...
def is_filled(solution):
    ...
    """
    # TODO: determine if all squares have only one solution
...
def search(solution):
    ...
    """
    # TODO: If any of the squares have no options then there is no solution

    # TODO: if all the the squares have only one option remaining we already have a solution
    ...
    # actually attempt the search
        ...
        square = min((s for s in squares if len(
            solution[s]) > 1), key=lambda s: len(solution[s]))

        # TODO: make a copy if we need to backtrack
...
if __name__ == '__main__':
    ...
    # TODO: initially every square has every option in the solution

    # TODO: join the lines we've read from our puzzle file with '' into one string

    # parse the puzzles from the string
    # TODO: parse our puzzle from the string given
    print('Puzzle:\n')
    # TODO: print our puzzle so we can see what it looks like before we solve it

    # TODO: attempt to solve the puzzle by assigning the known values

    # TODO: check if all squares have a single solution
    print('\nSolved by pure constraint propagation:\n')
    # TODO: else constraint propagation was insufficient
    print('\nConstraint propagation result:\n')
    # TODO: print out what we have in our solution

    # TODO: attempt a search!
    print('\nSearch result:\n')

    # TODO: print out our solution
