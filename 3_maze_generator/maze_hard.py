...
class Maze:
    ...
    def make_maze(self):
        ...
        # TODO: create current_cell and start at the requested start position
...
class MazeSolver:
    ...
    def __init__(self, maze):
        # TODO: set the maze instance variable
        # TODO: set the start instance variable in the format of a coordinate (x,y)
        # TODO: set the end instance variable in the format of a coordinate (x,y)
    ...
    def solve(self):
        ...
        """
        # TODO: Create necessary data structures
        # TODO: a queue called 'q' to keep track of cells to visit
        # TODO: a set called 'visited_nodes' to keep track of cells already visited
        # TODO: a dict called 'parents' to record the previous cell, i.e. parent in the BFS tree, visited when hunting for a solution

        # TODO: Initialize by putting the start in all the data structures
        # remember the start node will have no parents

        # TODO: While there are cells remaining to visit
