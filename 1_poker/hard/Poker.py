...
class Poker:
    ...
    def __init__(self):
        ...
        # TODO: Make a list to keep track of players that have not gone bankrupt
        # game information
        # TODO: create a dealer variable that holds None
...
class Round:
    ...
    def winner(self):
        # TODO: get the winner (self.active_players[0]) by checking if the length of the folded players - the length of active players == 1
    '''
    ...
    def play(self):
        # TODO: do blinds
        # TODO: call pre_flop()
        # TODO: start betting(), the pot will be unbalanced at the first call

        # TODO: call flop() to deal 3 cards face up

        # TODO: call betting(), this time the pot is balanced

        # TODO: loop through range(2)
        # TODO: in each iteration, another card is shown. then call betting, with a balanced pot

        # TODO: score player's hands, and get winner
        # TODO: give winnings to the winner
        pass
        #################################################################
