...
def knapsack_dp(capacity, item_weights, item_values, num_items):
    ...
    #       set k[cap][weight] to the max of the value one row above +
    #       [one row above, weight-item_weights[cap-1] or
    #       just the value one row above
    # TODO: else
    # TODO: set k[cap][weight] to previously found answer
